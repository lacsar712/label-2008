...
CREATE TABLE IF NOT EXISTS remember_tokens (
    ...
    token VARCHAR(255) NOT NULL UNIQUE COMMENT '记住我令牌',
...
(1, 'user_18', '192.168.1.28', '上海', 'mobile', 'iOS 16.0', DATE_SUB(NOW(), INTERVAL 50 HOUR)),
(2, 'user_19', '192.168.1.29', '广州', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 52 HOUR)),
(3, 'user_20', '192.168.1.30', '深圳', 'desktop', 'Edge/120.0', DATE_SUB(NOW(), INTERVAL 54 HOUR)),
(4, 'user_21', '192.168.1.31', '杭州', 'mobile', 'Android 13', DATE_SUB(NOW(), INTERVAL 56 HOUR)),
(5, 'user_22', '192.168.1.32', '成都', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 3 DAY)),
(1, 'user_23', '192.168.1.33', '武汉', 'desktop', 'Chrome/119.0', DATE_SUB(NOW(), INTERVAL 75 HOUR)),
(2, 'user_24', '192.168.1.34', '西安', 'mobile', 'Android 12', DATE_SUB(NOW(), INTERVAL 77 HOUR)),
(6, 'user_25', '192.168.1.35', '南京', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 79 HOUR)),
(7, 'user_26', '192.168.1.36', '重庆', 'tablet', 'iPadOS 17.0', DATE_SUB(NOW(), INTERVAL 4 DAY)),
(1, 'user_27', '192.168.1.37', '天津', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 98 HOUR)),
(3, 'user_28', '192.168.1.38', '苏州', 'mobile', 'iOS 16.0', DATE_SUB(NOW(), INTERVAL 100 HOUR)),
(8, 'user_29', '192.168.1.39', '长沙', 'desktop', 'Edge/120.0', DATE_SUB(NOW(), INTERVAL 102 HOUR)),
(1, 'user_30', '192.168.1.40', '郑州', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 5 DAY)),
(2, 'user_31', '192.168.1.41', '青岛', 'mobile', 'Android 13', DATE_SUB(NOW(), INTERVAL 122 HOUR)),
(4, 'user_32', '192.168.1.42', '大连', 'desktop', 'Chrome/119.0', DATE_SUB(NOW(), INTERVAL 124 HOUR)),
(5, 'user_33', '192.168.1.43', '厦门', 'desktop', 'Firefox/120.0', DATE_SUB(NOW(), INTERVAL 126 HOUR)),
(1, 'user_34', '192.168.1.44', '北京', 'mobile', 'iOS 17.0', DATE_SUB(NOW(), INTERVAL 6 DAY)),
(6, 'user_35', '192.168.1.45', '上海', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 147 HOUR)),
(7, 'user_36', '192.168.1.46', '广州', 'desktop', 'Chrome/120.0', DATE_SUB(NOW(), INTERVAL 149 HOUR)),
