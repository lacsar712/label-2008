...
<body class="auth-page">
            ...
            <div class="auth-container">
                ...
                <form id="loginForm" class="auth-form">
                    <div class="form-group">
                        <label for="username">用户名或邮箱 <span class="required">*</span></label>
                    ...
                    <div class="form-options">
                        ...
                        <a href="forgot_password.php" class="forgot-link">忘记密码？</a>
                    </div>
    ...
    <script>
        initAuthForm('loginForm', 'login', function(result) {
            setTimeout(() => {
